...
def generate_keys_for_game(game, client_token, retries=3, generated_keys=set()):
    keys = []
    ...
    for day in range(KEYS_DAY_COUNT):
        ...
        for game_id, game in games.items():
            ...
            try:
                ...
                keys[game['name']] = generate_keys_for_game(game, client_token, generated_keys=all_generated_keys)
            except Exception as e:
                print(f"Error: {e}")
